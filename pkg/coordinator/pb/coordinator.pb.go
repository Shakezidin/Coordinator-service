...
var file_coordinator_proto_rawDesc = []byte{
	...
	0x43, 0x61, 0x74, 0x61, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x3b, 0x0a, 0x10, 0x50, 0x61,
	0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x27,
	...
	0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x22, 0x30, 0x0a, 0x06, 0x56, 0x65, 0x72, 0x69, 0x66,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x4c, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x64, 0x22, 0x78, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x75,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xf7, 0x0a, 0x0a,
...
var file_coordinator_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_coordinator_proto_goTypes = []interface{}{
	...
	(*Responce)(nil),                // 12: pb.Responce
	(*Signup)(nil),                  // 13: pb.Signup
	(*Newpassword)(nil),             // 14: pb.newpassword
	(*ForgetPasswordVerify)(nil),    // 15: pb.forgetPasswordVerify
	(*ForgetPassword)(nil),          // 16: pb.forgetPassword
	(*View)(nil),                    // 17: pb.View
	(*Login)(nil),                   // 18: pb.Login
	(*SignupResponce)(nil),          // 19: pb.SignupResponce
	(*Activity)(nil),                // 20: pb.Activity
	(*FoodMenus)(nil),               // 21: pb.FoodMenus
	(*FoodMenu)(nil),                // 22: pb.FoodMenu
	(*Destination)(nil),             // 23: pb.Destination
	(*Package)(nil),                 // 24: pb.Package
	(*Category)(nil),                // 25: pb.Category
	(*LoginResponce)(nil),           // 26: pb.LoginResponce
}
var file_coordinator_proto_depIdxs = []int32{
	6,  // 0: pb.TravellerRequest.traveller_details:type_name -> pb.TravellerDetails
	25, // 1: pb.Catagories.Catagories:type_name -> pb.Category
	24, // 2: pb.PackagesResponce.Packages:type_name -> pb.Package
	22, // 3: pb.FoodMenus.Foodmenu:type_name -> pb.FoodMenu
	20, // 4: pb.Destination.activity:type_name -> pb.Activity
	25, // 5: pb.Package.category:type_name -> pb.Category
	23, // 6: pb.Package.Destinations:type_name -> pb.Destination
	13, // 7: pb.Coordinator.CoordinatorSignupRequest:input_type -> pb.Signup
	17, // 8: pb.Coordinator.CoordinatorViewPackages:input_type -> pb.View
	11, // 9: pb.Coordinator.CoordinatorSignupVerifyRequest:input_type -> pb.Verify
	18, // 10: pb.Coordinator.CoordinatorLoginRequest:input_type -> pb.Login
	24, // 11: pb.Coordinator.CoordinatorAddPackage:input_type -> pb.Package
	22, // 12: pb.Coordinator.CoordinatorAddFoodMenu:input_type -> pb.FoodMenu
	17, // 13: pb.Coordinator.CoordinatorViewFoodMenu:input_type -> pb.View
	23, // 14: pb.Coordinator.CoordinatorAddDestination:input_type -> pb.Destination
	20, // 15: pb.Coordinator.CoordinatorAddActivity:input_type -> pb.Activity
	17, // 16: pb.Coordinator.CoordinatorViewPackage:input_type -> pb.View
	17, // 17: pb.Coordinator.CoordinatorViewDestination:input_type -> pb.View
	17, // 18: pb.Coordinator.CoordinatorViewActivity:input_type -> pb.View
	16, // 19: pb.Coordinator.CoordinatorForgetPassword:input_type -> pb.forgetPassword
	15, // 20: pb.Coordinator.CoordinatorForgetPasswordVerify:input_type -> pb.forgetPasswordVerify
	14, // 21: pb.Coordinator.CoordinatorNewPassword:input_type -> pb.newpassword
	17, // 22: pb.Coordinator.AvailablePackages:input_type -> pb.View
	25, // 23: pb.Coordinator.AddCatagory:input_type -> pb.Category
	17, // 24: pb.Coordinator.AdminPacakgeStatus:input_type -> pb.View
	17, // 25: pb.Coordinator.ViewCatagories:input_type -> pb.View
	8,  // 26: pb.Coordinator.PackageSearch:input_type -> pb.Search
	1,  // 27: pb.Coordinator.FilterPackage:input_type -> pb.Filter
	7,  // 28: pb.Coordinator.TravellerDetails:input_type -> pb.TravellerRequest
	4,  // 29: pb.Coordinator.OfflineBooking:input_type -> pb.Booking
	4,  // 30: pb.Coordinator.OnlinePayment:input_type -> pb.Booking
	0,  // 31: pb.Coordinator.PaymentConfirmed:input_type -> pb.PaymentConfirmedRequest
	12, // 32: pb.Coordinator.CoordinatorSignupRequest:output_type -> pb.Responce
	10, // 33: pb.Coordinator.CoordinatorViewPackages:output_type -> pb.PackagesResponce
	12, // 34: pb.Coordinator.CoordinatorSignupVerifyRequest:output_type -> pb.Responce
	26, // 35: pb.Coordinator.CoordinatorLoginRequest:output_type -> pb.LoginResponce
	12, // 36: pb.Coordinator.CoordinatorAddPackage:output_type -> pb.Responce
	12, // 37: pb.Coordinator.CoordinatorAddFoodMenu:output_type -> pb.Responce
	21, // 38: pb.Coordinator.CoordinatorViewFoodMenu:output_type -> pb.FoodMenus
	12, // 39: pb.Coordinator.CoordinatorAddDestination:output_type -> pb.Responce
	12, // 40: pb.Coordinator.CoordinatorAddActivity:output_type -> pb.Responce
	24, // 41: pb.Coordinator.CoordinatorViewPackage:output_type -> pb.Package
	23, // 42: pb.Coordinator.CoordinatorViewDestination:output_type -> pb.Destination
	20, // 43: pb.Coordinator.CoordinatorViewActivity:output_type -> pb.Activity
	12, // 44: pb.Coordinator.CoordinatorForgetPassword:output_type -> pb.Responce
	12, // 45: pb.Coordinator.CoordinatorForgetPasswordVerify:output_type -> pb.Responce
	12, // 46: pb.Coordinator.CoordinatorNewPassword:output_type -> pb.Responce
	10, // 47: pb.Coordinator.AvailablePackages:output_type -> pb.PackagesResponce
	12, // 48: pb.Coordinator.AddCatagory:output_type -> pb.Responce
	12, // 49: pb.Coordinator.AdminPacakgeStatus:output_type -> pb.Responce
	9,  // 50: pb.Coordinator.ViewCatagories:output_type -> pb.Catagories
	10, // 51: pb.Coordinator.PackageSearch:output_type -> pb.PackagesResponce
	10, // 52: pb.Coordinator.FilterPackage:output_type -> pb.PackagesResponce
	5,  // 53: pb.Coordinator.TravellerDetails:output_type -> pb.TravellerResponse
	3,  // 54: pb.Coordinator.OfflineBooking:output_type -> pb.BookingResponce
	2,  // 55: pb.Coordinator.OnlinePayment:output_type -> pb.OnlinePaymentResponse
	3,  // 56: pb.Coordinator.PaymentConfirmed:output_type -> pb.BookingResponce
